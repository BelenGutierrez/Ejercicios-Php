            ...
            <div id="content">
                <div id="excursion">
                    ...
                    $_SESSION['excursiones'] = array(
                        "exc1" => array("nombre" => "Mujeres", "precio" => 1000, "imagen" => "mujeres.jpg", "detalle" => "Bla bla bla bla bla bla bla bla."),
                        "exc2" => array("nombre" => "Buceo", "precio" => 2400, "imagen" => "buceo.jpg", "detalle" => "Bla bla bla bla bla bla bla bla."),
                        "exc3" => array("nombre" => "Canoa", "precio" => 2850, "imagen" => "canoa.jpeg", "detalle" => "Bla bla bla bla bla bla bla bla."),
                        "exc4" => array("nombre" => "Tirolina", "precio" => 1600, "imagen" => "tirolina.jpg", "detalle" => "Bla bla bla bla bla bla bla bla.")
                    );
